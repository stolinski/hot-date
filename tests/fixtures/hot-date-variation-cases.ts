...
const MUST_PASS_SEEDS: SeedCase[] = [
  {
    ...
    expectedCanonicalValue: "2026-03-14T00:00:00Z/2026-03-28T00:00:00Z",
  },
  {
    flow: "exact_range",
    expectedKind: "range",
    input: "feb 18, 1988 - feb 29, 2024",
    expectedCanonicalValue: "1988-02-18T00:00:00Z/2024-02-29T00:00:00Z",
  },
  {
    flow: "relative_math",
    expectedKind: "point",
    input: "today + 9 days",
    expectedCanonicalValue: "2026-04-24T00:00:00Z",
  },
  {
    flow: "relative_math",
    expectedKind: "point",
    input: "next monday in march plus 2 weeks",
    expectedCanonicalValue: "2027-03-15T00:00:00Z",
  },
  {
    flow: "holiday_relative",
    expectedKind: "point",
    input: "friday before christmas",
    expectedCanonicalValue: "2026-12-18T00:00:00Z",
  },
  {
    flow: "holiday_anchor",
    expectedKind: "point",
    input: "christmas",
    expectedCanonicalValue: "2026-12-25T00:00:00Z",
  },
  {
    flow: "holiday_anchor",
    expectedKind: "point",
    input: "new year's day",
    expectedCanonicalValue: "2027-01-01T00:00:00Z",
  },
  {
    flow: "holiday_weekend",
    expectedKind: "range",
    input: "labor day weekend",
    expectedCanonicalValue: "2026-09-05T00:00:00Z/2026-09-06T00:00:00Z",
  },
  {
    flow: "relative_math",
    expectedKind: "point",
    input: "labor day weekend + a week",
    expectedCanonicalValue: "2026-09-13T00:00:00Z",
  },
  {
    flow: "single_date",
    expectedKind: "point",
    input: "march 1st 1986",
    expectedCanonicalValue: "1986-03-01T00:00:00Z",
  },
  {
    flow: "single_date",
    expectedKind: "point",
  ...
  },
  {
    ...
    expectedCanonicalValue: "2026-04-01T12:00:00Z/2026-04-15T12:00:00Z",
  },
  {
    flow: "reverse_date",
    expectedKind: "point",
    input: "5 years in the past",
    expectedCanonicalValue: "2021-04-15T12:00:00Z",
  },
  {
    flow: "reverse_date",
    expectedKind: "point",
    input: "1 hour from now",
    expectedCanonicalValue: "2026-04-15T13:00:00Z",
  },
];
